                ...
                <p>
                    ...
                    if (empty($character)) {
                        ...
                        foreach ($characters as $oneCharacter) {
                            echo '<button type="button" class="btn btn-dark"><a style="color:white;" href="?fight=' . $oneCharacter->id() . '">' . htmlspecialchars($oneCharacter->nameChar()) . '</a></button> (classe : '.$oneCharacter->classChar().' dégâts : ' . $oneCharacter->damage() . ', force : ' . $oneCharacter->strength() . ', level : ' . $oneCharacter->levelChar() . ', DGT : '.(int) (($oneCharacter->levelChar() * 0.2) + 10).' - '.(int) (($oneCharacter->strength() * 0.2) + 10).' )<br />';
                        }
                    }
                    ?>
                </p>
